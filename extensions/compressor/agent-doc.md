...
The level is the peak of both channels. For a steady sound whose peak is 12 dB over the threshold at `ratio` 4, the sound comes out 9 dB quieter, plus `makeup_db`. An edit applies while the track plays and glides over 20 ms, so it does not click.
