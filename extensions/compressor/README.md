...
- The stretches of 1 ms begin with the first frame of sound after a rest, not at `prepare`: the compressor starts at rest, and a sound after a silence that has left it starts a new stretch. So how much silence came before a sound, and in what blocks, changes nothing of what it becomes, to the bit. Before, two renders of one sound after 64 frames more silence had their stretches 16 frames apart.
- Under 50 Hz a stretch can fall between two peaks of the wave, so the level dips, the gain follows the wave and the compressor adds harmonics. Measured for a sine at -6 dBFS into threshold -20 dB, 4:1, attack 1 ms: at 25 Hz the harmonics are 35 dB under the tone with a release of 10 ms and 54 dB under with 120 ms; at 40 Hz, 67 and 87 dB under. A longer release keeps deep bass cleaner.
...
- The gain of a steady 1 kHz sine is the static gain within 0.0000 dB (printed to four places) for the 48 settings of the test (threshold -60, -30, -10 and 0 dB, ratio 1, 2, 8 and 100, knee 0, 6 and 18 dB), from -60 to +6 dBFS in. At 50, 100, 440, 5000 and 15000 Hz it is the same for one setting (threshold -24 dB, 4:1, knee 6 dB) at four levels. By hand: threshold -20 dB, 4:1, hard knee gives 0, -3, -9 and -15 dB at -20, -16, -8 and 0 dBFS in.
