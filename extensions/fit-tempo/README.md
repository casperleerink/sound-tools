...
- The first downbeat lands on a bar line. The bars before it hold the beats played before it, the pickup, plus at least one bar for the silence in front of the take. The tempo of that lead stretches to cover exactly the time between the start of the piece and the first beat of the take, so the take stays where it was heard.
