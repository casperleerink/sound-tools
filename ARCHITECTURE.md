...
- Decided for step 6b: the note editor is a panel inside the arrangement view, owned by the arrangement extension. The main area of the window stays one root view, and the window does not know the editor.
