...
- One tempo step per beat, and a beat that the step before it already lands right shares that step. The first downbeat lands on a bar line; the bars before it hold the pickup that was played plus at least one bar for the silence in front of the take, and the tempo of that lead stretches to cover exactly the time from the start of the piece to the first beat of the take. That is the simplest rule for the time before the downbeat and it keeps the take where it was heard.
